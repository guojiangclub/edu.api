...
<div class="tabs-container" id="wizard">
    ...
    {!! Form::open( [ 'url' => [route('edu.course.store')], 'method' => 'POST', 'id' => 'base-form','class'=>'form-horizontal'] ) !!}
    <div class="tab-content items">
        <div class="tab-pane active" id="tab_1">
            <div class="panel-body">
                @include('edu-backend::course.includes.create_base')
            </div><!-- /.tab-pane -->
        </div>
        ...
        <div class="tab-pane" id="tab_3">
            <div class="panel-body">
                @include('edu-backend::course.includes.create_price')
            </div>
            ...
            success: function (result) {
                if (!result.status) {
                    ...
                    swal({
                        ...
                        window.location.href="{{route('edu.course.list',['status'=>'draft'])}}";
                    });
                }
