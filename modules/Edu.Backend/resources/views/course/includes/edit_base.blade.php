...
<div class="form-group">
    ...
    <div class="col-sm-10">
        <input type="text" class="form-control" name="subtitle" placeholder=""  value="{{$course->subtitle}}">
    </div>
</div>
    ...
    <div class="col-sm-10">
        <div class="input-group m-b">
            <input class="form-control number_valid"
                   name="expiry_day" type="text"  value="{{$course->expiry_day}}"> <span
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        <input type="hidden" name="picture" value="{{$course->picture}}">
...
@if($teacher!=null)
    <script>
        data['result'][0]=JSON.parse('{!! $teacher !!}');
    </script>
@endif
