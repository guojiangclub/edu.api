{!! Html::script(env("APP_URL").'/assets/edu-backend/libs/formvalidation/dist/js/formValidation.min.js') !!}
{!! Html::script(env("APP_URL").'/assets/edu-backend/libs/formvalidation/dist/js/framework/bootstrap.min.js') !!}
{!! Html::script(env("APP_URL").'/assets/edu-backend/libs/formvalidation/dist/js/language/zh_CN.js') !!}
{!! Html::script(env("APP_URL").'/assets/edu-backend/libs/Tagator/fm.tagator.jquery.js') !!}
...
{!! Html::script(env("APP_URL").'/assets/edu-backend/libs/linkchecked/el.linkchecked.js') !!}
