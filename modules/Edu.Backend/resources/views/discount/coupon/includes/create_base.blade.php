...
{{--<div class="form-group">--}}
    {{--<label class="col-sm-3 control-label">展示图片--}}
        {{--<i class="fa fa-question-circle"--}}
                                                 {{--data-toggle="tooltip" data-placement="top"--}}
                                                 {{--data-original-title="--}}
                                                 {{--建议上传小于2M的正方形图片；不上传则默认显示商家LOGO"></i>--}}
        {{--：</label>--}}
    {{--<div class="col-sm-9">--}}
        {{--<div class="pull-left" id="activity-poster">--}}
            {{--<img src="--}}
{{--{{settings('shop_show_logo')?settings('shop_show_logo'):'/assets/backend/activity/backgroundImage/pictureBackground.png'}}--}}
                    {{--"--}}
                 {{--alt="" class="img" width="182px"  style="margin-right: 23px;">--}}
            {{--<input type="hidden" name="base[discount_img]" class="form-control" value="--}}
{{--{{settings('shop_show_logo')?settings('shop_show_logo'):''}}--}}
                    {{--">--}}
        {{--</div>--}}
...
{{--<div class="form-group" style="display: none" id="agent_ids_box">--}}
    {{--<label class="col-sm-3 control-label">分销员ID：</label>--}}
    {{--<div class="col-sm-9">--}}
        {{--<input type="text" class="form-control" name="agent_ids" placeholder="如需指定分销员可见，请输入分销员ID，以逗号分隔"/>--}}
    {{--</div>--}}
{{--</div>--}}
