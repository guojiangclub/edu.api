...
<div class="form-group">
    ...
    <div class="col-sm-9">
        <input type="text" class="form-control" required name="base[title]" placeholder=""
...
{{--<div class="form-group">--}}
    {{--<label class="col-sm-3 control-label"><span class="sp-require">*</span>展示图片--}}
        {{--<i class="fa fa-question-circle"--}}
                                                                                  {{--data-toggle="tooltip"--}}
                                                                                  {{--data-placement="top"--}}
                                                                                  {{--data-original-title="建议上传小于2M的正方形图片；不上传则默认显示商家LOGO"></i>--}}
        {{--：</label>--}}
    {{--<div class="col-sm-9">--}}
...
{{--<div class="form-group">--}}
    {{--<label class="col-sm-3 control-label"><span class="sp-require"></span></label>--}}
    {{--<div class="col-sm-9">--}}
...
{{--<div class="form-group">--}}
    ...
    {{--<div class="col-sm-9 toggle-status">--}}
...
{{--<div class="form-group" style="display: {{$discount->is_agent_share?'block':'none'}}" id="agent_ids_box">--}}
    {{--<label class="col-sm-3 control-label">分销员ID：</label>--}}
    {{--<div class="col-sm-9">--}}
        {{--<input type="text" class="form-control" name="agent_ids" value="{{$discount->agent_ids}}" placeholder="如需指定分销员可见，请输入分销员ID，以逗号分隔"/>--}}
    {{--</div>--}}
{{--</div>--}}
...
<div class="form-group">
    ...
    <div class="col-sm-9">
        <div class="input-group date form_datetime">
            ...
            <input type="text" name="base[usestart_at]" class="form-control inline" id="date-range14"
                   value="{{$discount->usestart_at}}" placeholder="点击选择使用开始时间">
            <span class="add-on"><i class="icon-th"></i></span>
        </div>
...
<div class="form-group">
    ...
    <div class="col-sm-9">
        <div class="input-group date form_datetime">
                                        <span class="input-group-addon" style="cursor: pointer">
                                            <i class="fa fa-calendar"></i>&nbsp;&nbsp</span>
            <input type="text" name="base[useend_at]" class="form-control inline" id="date-range13"
                   value="{{$discount->useend_at}}" placeholder="点击选择使用截止时间">
            <span class="add-on"><i class="icon-th"></i></span>
        </div>
...
{{--<div class="form-group">--}}
    ...
    {{--<div class="col-sm-9">--}}
        {{--<input type="text" class="form-control" name="base[url]" value="{{$discount->url}}"--}}
               {{--placeholder="请输入整个url，包含http"/>--}}
    {{--</div>--}}
{{--</div>--}}