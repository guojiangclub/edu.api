            ...
            <div class="panel-body">
                <div class="col-sm-8">
                    <fieldset class="form-horizontal">
                        @include('edu-backend::discount.coupon.includes.create_base')
                    </fieldset>

                    <fieldset class="form-horizontal">
                        @include('edu-backend::discount.coupon.create_rule')
                    </fieldset>

                    <fieldset class="form-horizontal">
                        @include('edu-backend::discount.coupon.includes.create_action')
                    </fieldset>
                </div>
