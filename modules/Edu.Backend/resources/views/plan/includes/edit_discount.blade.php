<div class="form-group">
    ...
    <div class="col-sm-9">
        <label class="checkbox-inline i-checks"><input name="is_discount" type="radio" value="0" {{$plan->is_discount?'':'checked'}}> 否</label>
        <label class="checkbox-inline i-checks"><input name="is_discount" type="radio" value="1" {{$plan->is_discount?'checked':''}}> 是</label>
    </div>
</div>

<div id="discount_area" style="display: {{$plan->is_discount?'':'none'}}">
    <div class="form-group">
        <label class="col-sm-2 control-label">促销价格：</label>
        <div class="col-sm-10">
            <div class="input-group m-b">
                <input class="form-control" value="{{$plan->discount_price}}"
        ...
        <div class="col-sm-10" id="two-inputs">
            ...
            <div class="col-sm-6">
                <div class="input-group date form_datetime" id="end_at">
                    ...
                    <input type="text" name="discount_ends_at" class="form-control inline" id="date-range201" value="{{$plan->discount_ends_at}}"
